...
[MultiResUNet](multiresunet.md), or ResUNet++ for related but non-identical
designs.
...
| [MultiResUNet](multiresunet.md) | Adds multi-resolution local blocks and ResPaths on skip connections. |
